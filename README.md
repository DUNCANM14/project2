...
This is the backend for my ASE 230 Project 2. I rebuilt my Project 1 REST API using Laravel 12, added Sanctum token authentication, and deployed everything using Docker so the API is easy to run anywhere. This repo contains the full Laravel codebase, migrations, controllers, and automation scripts.
...
Dockerfile for building the Laravel app image

setup.sh and run.sh automation scripts
...
Make sure the database settings match your Docker setup:
...
Rebuild the Laravel app container:
...
Full documentation for this project is published at:
https://duncanm14.github.io/project2-docs/

End of README

This covers everything needed to run, test, and understand the backend portion of my Project 2.
